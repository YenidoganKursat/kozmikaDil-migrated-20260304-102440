...
PROGRAM_DIR = os.path.join(ROOT_DIR, "bench", "programs", "scalar_runtime")
...
PHASE_DEFAULTS = {
    "scalar_runtime": {
        ...
        "program_dir": os.path.join(ROOT_DIR, "bench", "programs", "scalar_runtime"),
        "result_basename": "scalar_runtime_benchmarks",
    },
    "containers_primitives": {
        "benchmarks": BENCHMARKS_PHASE5,
        "program_dir": os.path.join(ROOT_DIR, "bench", "programs", "containers_primitives"),
        "result_basename": "containers_primitives_benchmarks",
    },
}

ACTIVE_BENCHMARKS = BENCHMARKS_PHASE4
PROGRAM_DIR = PHASE_DEFAULTS["scalar_runtime"]["program_dir"]
BASELINE_DIR = os.path.join(PROGRAM_DIR, "c_baselines")
RESULT_BASENAME = PHASE_DEFAULTS["scalar_runtime"]["result_basename"]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=[4, 5],
        default=4,
        help="benchmark phase (4 for scalar_runtime scalar, 5 for containers_primitives containers)",
    )
    parser.add_argument(
        "--runs",
        type=int,
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=None,
        help="allow T5 tier codegen for benchmarked builds (containers_primitives default: true)",
    )
    parser.add_argument(
        "--adaptive-probe-runs",
        type=int,
    ...
    parser.add_argument(
        ...
        help="native compile profile (scalar_runtime default: aggressive, containers_primitives default: aggressive): portable, native, aggressive, max",
    )
    parser.add_argument(
        "--baseline-profile",
    ...
    if args.show_config:
        print("scalar_runtime benchmark config:")
