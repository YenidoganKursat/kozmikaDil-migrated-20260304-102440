...
def main():
    ...
    parser.add_argument("--json-out", default="bench/results/platform_support_runtime_fuzz.json")
    parser.add_argument("--csv-out", default="bench/results/platform_support_runtime_fuzz.csv")
    ...
    records = []
    with tempfile.TemporaryDirectory(prefix="spark_platform_support_runtime_fuzz_") as td:
        temp_dir = Path(td)
    ...
    print(f"platform_support runtime fuzz: {payload['passed']}/{payload['cases']} passed")
