...
TEST_TARGETS = [
    ...
    "sparkc_containers_primitives_tests",
    "sparkc_hetero_runtime_tests",
    "sparkc_stream_pipeline_tests",
    "sparkc_matmul_schedule_gpu_tests",
    "sparkc_async_runtime_tests",
    "sparkc_platform_support_tests",
]
...
def execute_config(root, name, cxx_flags, exe_flags):
    build_dir = root / "build" / f"platform_support_{name}"
    configure_cmd = [
        "cmake",
        "-S",
        str(root),
...
def main():
    ...
    parser.add_argument("--json-out", default="bench/results/platform_support_sanitizers.json")
    parser.add_argument("--csv-out", default="bench/results/platform_support_sanitizers.csv")
    ...
    print(f"platform_support sanitizers: {payload['passed']}/{payload['total']} passed")
